...
- Los tres hechizos iniciales (Slicing Chop I, Swiftness Song I, Injury Cure
  I). En la captura llegan como 0x000D con id de mensaje 425, y son los que
  el cliente pone en la barra F1..F3. No se mandan.
...
- **Las skills en el panel.** El 0x001C generado sale identico byte a byte al
  ...
  (Slicing Chop I, Swiftness Song I, Injury Cure I) con id de mensaje 425, y
  esos no se mandan.
- **Borrar personajes.**
